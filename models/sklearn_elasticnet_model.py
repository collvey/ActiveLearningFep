...
"""Module for constructing sklearn ElasticNet regressor model."""
import os
...
class SklearnElasticNetModel(makita_model.MakitaModel):
  """Sklearn ElasticNet regression model for Makita concentrated pipelines."""
  ...
  def __init__(self, model_hparams,
    ...
    self._model = linear_model.ElasticNetCV(**self._model_hparams)
