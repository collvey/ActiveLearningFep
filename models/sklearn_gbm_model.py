...
"""Module for constructing sklearn gradient-boosted trees model."""
import os
...
class SklearnGbmModel(makita_model.MakitaModel):
  """Sklearn gradient-boosted trees model for Makita concentrated pipelines."""
  ...
  def __init__(self, model_hparams,
    ...
    self._model = ensemble.GradientBoostingRegressor(**self._model_hparams)
