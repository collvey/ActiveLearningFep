...
"""Module for constructing sklearn random forest model."""
import os
...
class SklearnRfModel(makita_model.MakitaModel):
  """Sklearn random forest model for Makita concentrated pipelines."""
  ...
  def __init__(self, model_hparams,
    ...
    self._model = ensemble.RandomForestRegressor(**self._model_hparams)
